    ...
    try {
        ...
        try {
            ...
            sendWelcomeEmail({
                ...
                console.warn('[Cashfree Verify & Register] Welcome email trigger failed (non-blocking):', emailErr);
            });
        } catch (mailImportErr) {
            console.warn('[Cashfree Verify & Register] Could not load sendWelcomeEmail:', mailImportErr);
        }
